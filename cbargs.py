...
def parseArguments():
  ...
  parser.add_argument('--timeout', '-t', default=2, type=float, help='Operation Timeout')
  parser.add_argument('--expiry', '-e', default=0, type=int, help='Documents Time To Live in seconds')
